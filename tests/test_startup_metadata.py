...
def test_get_by_description(sample_startup_data):
    ...
    result = lookup.get_by_description('An AI company that does machine learning. Using cutting-edge algorithms to solve complex problems. Targeting enterprise customers.')
    assert result is not None
    assert result['name'] == 'AI Company'
